...
<?php $component->withAttributes(['heading' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Two Factor Authentication')),'subheading' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Manage your two-factor authentication settings'))]); ?>
        <div class="flex flex-col w-full mx-auto space-y-6 text-sm" wire:cloak>
            <!--[if BLOCK]><![endif]--><?php if($twoFactorEnabled): ?>
                <div class="space-y-4">
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1764860439-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
            ...
            <!--[if BLOCK]><![endif]--><?php if($showVerificationStep): ?>
                <div class="space-y-6">
...
<?php endif; ?>
            ...
            <?php else: ?>
                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['setupData'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <div class="flex justify-center">
                    <div class="relative w-64 overflow-hidden border rounded-lg border-stone-200 dark:border-stone-700 aspect-square">
                        <!--[if BLOCK]><![endif]--><?php if(empty($qrCodeSvg)): ?>
                ...
                <div class="space-y-4">
                    ...
                    >
                        <div class="flex items-stretch w-full border rounded-xl dark:border-stone-700">
                            <!--[if BLOCK]><![endif]--><?php if(empty($manualSetupKey)): ?>
...
<?php /**PATH C:\daw\dwm\bike_maintenance\resources\views/livewire/settings/two-factor.blade.php ENDPATH**/ ?>