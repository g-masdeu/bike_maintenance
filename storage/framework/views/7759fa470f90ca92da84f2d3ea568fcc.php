...
<body>
    ...
    <header class="fonsHeaderFooter">
        ...
        <nav>
            <a onclick="openModal('loginModal')"><?php echo e(__('messages.login', [], app()->getLocale()) ?: 'Login'); ?></a>
            <a class="button" onclick="openModal('registerModal')">
                <?php echo e(__('messages.register', [], app()->getLocale()) ?: 'Register'); ?>
    ...
    <main>
        ...
        <section class="features">
            <div class="feature-card">
                ...
                <h3><?php echo e(__('messages.feature_kilometers') ?: 'Track Kilometers'); ?></h3>
            </div>
            <div class="feature-card">
                <img src="/images/mantenimiento_welcome.png" alt="Maintenance">
                <h3><?php echo e(__('messages.feature_maintenance') ?: 'Maintenance Log'); ?></h3>
            </div>
            <div class="feature-card">
                <img src="/images/bikes_welcome.png" alt="Bike Types">
                <h3><?php echo e(__('messages.feature_biketype') ?: 'Bike Types'); ?></h3>
            </div>
        </section>
    </main>
