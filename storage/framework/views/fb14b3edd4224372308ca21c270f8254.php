...
<div class="max-w-md mx-auto mt-3 p-6 bg-white dark:bg-gray-800 rounded-lg shadow">
    ...
    <form action="<?php echo e(route('bicicletas.store')); ?>" method="POST">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\daw\dwm\bike_maintenance\resources\views/bicicletas/create.blade.php ENDPATH**/ ?>