    ...
    @auth
        ...
        <div
            ...
            <nav class="flex-1 px-4 py-6 space-y-2">
                ...
                <a href="{{ route('home') }}"
                    class="flex items-center px-2 py-2 text-sm font-medium rounded hover:bg-gray-200 dark:hover:bg-gray-700 {{ request()->routeIs('home') ? 'bg-gray-200 dark:bg-gray-700' : '' }}">
            ...
            <div class="px-4 py-6 border-t border-gray-200 dark:border-gray-700">
                <div class="flex items-center space-x-3">
                    <div
                        class="flex items-center justify-center w-8 h-8 rounded-full bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-white">
                ...
                <div class="mt-4 space-y-2">
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit"
                            class="w-full text-left px-2 py-2 text-sm font-medium rounded hover:bg-gray-200 dark:hover:bg-gray-700">
                            Tancar sessió
                        </button>
                    </form>
                </div>
