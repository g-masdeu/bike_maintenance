...
<head>
    ...
    <style>
        ...
        *::after {
        ...
        .hero-container .buttons a.primary:hover {
            background-color: #2563eb;
        }
        ...
        .hero-container .buttons a.secondary:hover {
...
<body>
    ...
    <header class="fonsHeaderFooter">
        ...
        <nav>
            <a onclick="openModal('loginModal')">{{ __('messages.login', [], app()->getLocale()) ?: 'Login' }}</a>
            <a class="button" onclick="openModal('registerModal')">
                {{ __('messages.register', [], app()->getLocale()) ?: 'Register' }}
            </a>
        </nav>
    </header>
    ...
    <main>
        ...
        <section class="hero-container">
            ...
            <p>{{ __('messages.hero_text') ?: "Track maintenance, monitor kilometers, and extend your bike's lifespan." }}
            </p>
            <div class="buttons">
                <a class="primary"
                    onclick="openModal('registerModal')">{{ __('messages.start_now') ?: 'Start Now' }}</a>
                <a class="secondary"
                    onclick="openModal('loginModal')">{{ __('messages.already_account') ?: 'Sign In' }}</a>
            </div>
        </section>
        ...
        <section class="features">
            <div class="feature-card">
                <img src="/images/kilometers_welcome.png" alt="Kilometers">
                <h3>{{ __('messages.feature_kilometers') ?: 'Track Kilometers' }}</h3>
            </div>
            <div class="feature-card">
                <img src="/images/mantenimiento_welcome.png" alt="Maintenance">
                <h3>{{ __('messages.feature_maintenance') ?: 'Maintenance Log' }}</h3>
            </div>
            <div class="feature-card">
                <img src="/images/bikes_welcome.png" alt="Bike Types">
                <h3>{{ __('messages.feature_biketype') ?: 'Bike Types' }}</h3>
            </div>
        </section>
    </main>
        ...
        <div class="modal-content">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="email" id="login-email" name="email" placeholder="exemple@correu.com" required
                        autofocus>
                ...
                <div class="form-group">
                    ...
                    <div class="forgot-password-link">
                        <a href="{{ route('password.request') }}"
                            onclick="event.preventDefault(); closeModal('loginModal'); window.location.href='{{ route('password.request') }}'">Has
        ...
        <div class="modal-content">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="register-name" name="name" placeholder="Nom complet" required
                        autofocus>
